 ...
 * apidoc:0.11.51 http://www.apidoc.me/gilt/svc-sundial/0.0.9/play_2_x_json
 */
package com.gilt.svc.sundial.v0.models {
  ...
  case class EmrJarCommand(
    jar: String,
    mainClass: String,
    args: Seq[String],
    properties: Seq[com.gilt.svc.sundial.v0.models.Property]
  ) extends TaskExecutable
...
package com.gilt.svc.sundial.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsSvcSundialEmrJarCommand: play.api.libs.json.Reads[EmrJarCommand] = {
      (
        (__ \ "jar").read[String] and
        (__ \ "mainClass").read[String] and
        (__ \ "args").read[Seq[String]] and
        (__ \ "properties").read[Seq[com.gilt.svc.sundial.v0.models.Property]]
      )(EmrJarCommand.apply _)
    }

    def jsObjectEmrJarCommand(obj: com.gilt.svc.sundial.v0.models.EmrJarCommand) = {
      play.api.libs.json.Json.obj(
        "jar" -> play.api.libs.json.JsString(obj.jar),
        "mainClass" -> play.api.libs.json.JsString(obj.mainClass),
        "args" -> play.api.libs.json.Json.toJson(obj.args),
        "properties" -> play.api.libs.json.Json.toJson(obj.properties)
      )
    }
    ...
    implicit def jsonReadsSvcSundialProperty: play.api.libs.json.Reads[Property] = {
      (
        (__ \ "key").read[String] and
        (__ \ "value").read[String]
      )(Property.apply _)
    ...
    def jsObjectProperty(obj: com.gilt.svc.sundial.v0.models.Property) = {
      play.api.libs.json.Json.obj(
        "key" -> play.api.libs.json.JsString(obj.key),
        "value" -> play.api.libs.json.JsString(obj.value)
      )
    ...
    implicit def jsonWritesSvcSundialProperty: play.api.libs.json.Writes[Property] = {
      new play.api.libs.json.Writes[com.gilt.svc.sundial.v0.models.Property] {
        def writes(obj: com.gilt.svc.sundial.v0.models.Property) = {
          jsObjectProperty(obj)
        }
      }
    }
    ...
    implicit def jsonReadsSvcSundialTaskExecutable: play.api.libs.json.Reads[TaskExecutable] = {
      (
        ...
        orElse
        (__ \ "emr_jar_command").read(jsonReadsSvcSundialEmrJarCommand).asInstanceOf[play.api.libs.json.Reads[TaskExecutable]]
        orElse
    ...
    def jsObjectTaskExecutable(obj: com.gilt.svc.sundial.v0.models.TaskExecutable) = {
      obj match {
        ...
        case x: com.gilt.svc.sundial.v0.models.EmrJarCommand => play.api.libs.json.Json.obj("emr_jar_command" -> jsObjectEmrJarCommand(x))
